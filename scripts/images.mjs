...
const QUERIES = {
  ...
  'ano-nuevo': 'Año Nuevo State Park',
  'fitzgerald-marine-reserve': 'Fitzgerald Marine Reserve',
  'filbert-steps': 'Filbert Street (San Francisco)',
  'sutro-baths': 'Sutro Baths',
  'wave-organ': 'Wave Organ',
  'balmy-alley': 'Mission District, San Francisco',
  'molly-tea-university': 'Palo Alto, California',
  'equator-fort-mason': 'Fort Mason',
  'hike-arastradero': 'Arastradero Preserve',
  'hike-foothills': 'Foothills Nature Preserve',
  'hike-windy-hill': 'Windy Hill Open Space Preserve',
  'hike-rancho-san-antonio': 'Rancho San Antonio Open Space Preserve',
  'hike-purisima': 'Purisima Creek Redwoods Open Space Preserve',
  'hike-mori-point': 'Mori Point',
  'hike-tennessee-valley': 'Tennessee Valley',
  'hike-steep-ravine-matt-davis': 'Mount Tamalpais',
  'ride-golden-gate-sausalito': 'Golden Gate Bridge',
  'ride-golden-gate-park-ocean': 'Golden Gate Park',
  'ride-sawyer-camp': 'Sawyer Camp Trail',
  'ride-bay-trail-baylands-shoreline': 'Palo Alto Baylands Nature Preserve',
  'ride-portola-loop': 'Portola Valley, California',
  'ride-old-la-honda': 'Portola Valley, California',
  'watch-oracle-park': 'McCovey Cove',
  'watch-chase-center': 'Chase Center',
  'watch-levis-stadium': "Levi's Stadium",
  'watch-stanford-stadium': 'Stanford Stadium',
  'giants-dodgers-2026-09': 'McCovey Cove',
  'stanford-georgia-tech-2026': 'Stanford Stadium',
  'valkyries-playoffs-2026': 'Chase Center',
  '49ers-broncos-2026': "Levi's Stadium",
  'fleet-week-2026': 'Marina Green',
  'stanford-elon-2026': 'Stanford Stadium',
  '49ers-commanders-2026': "Levi's Stadium",
  'warriors-opener-2026': 'Chase Center',
  'stanford-nc-state-2026': 'Stanford Stadium',
  '49ers-raiders-2026': "Levi's Stadium",
  'stanford-smu-2026': 'Stanford Stadium',
  '49ers-seahawks-2026': "Levi's Stadium",
  'sfjazz-center': 'SFJAZZ Center',
  'black-cat-sf': 'Tenderloin, San Francisco',
  'punch-line-sf': 'Punch Line San Francisco',
  'cobbs-comedy-club': "Cobb's Comedy Club",
  'bats-improv': 'Fort Mason',
  'the-fillmore': 'The Fillmore',
  'great-american-music-hall': 'Great American Music Hall',
  'vesuvio': 'Vesuvio Cafe',
  'tosca-cafe': 'North Beach, San Francisco',
  'li-po-lounge': 'Chinatown, San Francisco',
  'smugglers-cove': "Smuggler's Cove (bar)",
  'trick-dog': 'Mission District, San Francisco',
  'zam-zam': 'Haight-Ashbury',
  'rose-and-crown-pa': 'Palo Alto, California',
  'dutch-goose': 'Menlo Park, California',
  'british-bankers-club': 'Menlo Park, California',
  'frost-amphitheater': 'Stanford University',
  'bing-concert-hall': 'Bing Concert Hall',
  'orens-hummus-university': 'Palo Alto, California',
  'ettan-palo-alto': 'Palo Alto, California',
  'rooh-palo-alto': 'Palo Alto, California',
  'khazana-palo-alto': 'Palo Alto, California',
  'pho-ha-noi-palo-alto': 'Pho',
  'local-union-271': 'Palo Alto, California',
  'bevri-palo-alto': 'Khachapuri',
  'taverna-palo-alto': 'Palo Alto, California',
  'telegraph-hill-steps': 'Coit Tower',
  'lands-end-sutro': 'Lands End (San Francisco)',
...
const CONTEXT_ONLY = new Set([
  ...
  'local-union-271', 'bevri-palo-alto', 'taverna-palo-alto',
  'frost-amphitheater', 'black-cat-sf', 'bats-improv', 'tosca-cafe', 'li-po-lounge', 'trick-dog', 'zam-zam', 'rose-and-crown-pa', 'dutch-goose', 'british-bankers-club',
